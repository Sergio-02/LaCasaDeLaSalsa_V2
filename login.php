...
<body class="main-layout about_page">
    ...
    <header>
                    ...
                    <div class="full">
                        <div class="right_header_info">
                            <ul>
                                ...
                                <li class="button_user"><a class="button" href="registro.html">Register</a></li>
        ...
        <div class="cont-menu">
            <form class="cont-login" action="validar.php" method="post">
                <h1 class="titulo-login">Inicio de sesión</h1>
                <input class="inp-login" type="text" placeholder="Nombre" name="usuario">
                <input class="inp-login" type="password" placeholder="Contraseña" name="contraseña">
