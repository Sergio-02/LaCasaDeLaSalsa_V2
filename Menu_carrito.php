...
<head>
    ...
    <link rel="stylesheet" href="css/cssMenu/estilos.css">
</head>
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="item shadow mb-4">
                            ...
                            <img class="item-image" src="./images/Imagen_1.jpeg">
    ...
    <footer class="bg-dark p-3 mt-5">
        <p class="text-center m-0 text-muted">La casa de las salsas</p>
    </footer>
